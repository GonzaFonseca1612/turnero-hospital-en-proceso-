...
<body background="../imagenes/Fondo1.jpg">
        <div class="login-container position-absolute top-50 start-50 translate-middle">
            ...
            <br>
                <img src="../imagenes/Logo 2.png" height="200px" width="400px">
                <h1 class="title">Bienvenido Doctor</h1>
                <p style="font-family:''Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif';">Complete sus datos de acceso para ingresar</p>
                <form class="inputs-container" action="../admin/validarMed.php" method="POST">
                    <input class="input border border-dark border-2" type="text" placeholder="DNI" name="dni">
                    <input class="input border border-dark border-2" type="password" placeholder="contraseña" name="psw">
